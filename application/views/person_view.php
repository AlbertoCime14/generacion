...
<html>
    ...
    <title>CRUD usando Codeignater</title>
...
<body>
    <div class="container">
        <h1 style="font-size:20pt">Crud de usuarios UTM</h1>

        <h3>Datos de los usuarios</h3>
        <br />
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Añadir usuario</button>
...
function edit_person(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="curriculum"]').val(data.curriculum);
        ...
        success: function(data)
        {
            ...
            if(data.status) //if success close modal and reload ajax table
            {
                ...
                Swal.fire({
                    ...
                    icon: 'success',
                    title: 'El usuario ha sido guardado con éxito',
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="Area" class="form-control">
                                    ...
                                    <option value="multimedia">Multimedia y comercio electrónico</option>
                                </select>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="curriculum" placeholder="Curriculum" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3" id="label-photo">Subir Photo </label>
                            <div class="col-md-9">
