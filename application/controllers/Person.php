...
class Person extends CI_Controller {
	...
	private function _do_upload()
	{
        ...
        $config['max_width']            = 2500; // set max width image allowed
        $config['max_height']           = 2500; // set max height allowed
	...
	private function _validate()
	{
		...
		if($this->input->post('email') == '')
		{
			...
			$data['error_string'][] = 'El email es requerido';
			$data['status'] = FALSE;
		}
		...
		if($this->input->post('Area') == '')
		{
			...
			$data['error_string'][] = 'Por favor seleccione un Área';
			$data['status'] = FALSE;
		}

		if($this->input->post('curriculum') == '')
		{
			$data['inputerror'][] = 'curriculum';
			$data['error_string'][] = 'El curriculum es requerido';
			$data['status'] = FALSE;
		}
